...
namespace API\CheckPrice\Domain\Generic\ValueObjects\Date;
...
class DateValueObject
{
    ...
    public function getNumericMonth($getMonthWithZeroBefore = false)
    {
        if ($getMonthWithZeroBefore) {
            return str_pad($this->numericMonth, 2, '0', STR_PAD_LEFT);
        }
